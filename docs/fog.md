...
Fleet's deferred efforts moved to [`docs/fog.md` in `Kylevdm/pi-fleet`](https://github.com/Kylevdm/pi-fleet/blob/main/docs/fog.md) on 2026-09-24, beside the maps and code they index.
